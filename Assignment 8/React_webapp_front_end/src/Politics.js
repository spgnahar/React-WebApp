...
import ReactTooltip from 'react-tooltip'
 ...
 class Politics  extends React.Component{
	...
	componentDidMount(){
        var url="https://newsapp-backend.appspot.com/guardian/section?sec=politics";
        ...
        var url1="https://newsapp-backend.appspot.com/newyork/section?sec=politics";
		fetch(url1)
		.then(response => {
			if(response.status !==200){
				throw new Error("File not recieved")
	...
	render(){
		...
		<Navbar.Collapse id="responsive-navbar-nav">
			<Nav className="mr-auto" >
				...
				<Nav.Link as={Link} to="/Politics" href="/Politics" style={{color:"white"}}>Politics</Nav.Link>
