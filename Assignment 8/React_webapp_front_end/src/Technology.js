...
import ReactTooltip from 'react-tooltip'
 class Technology  extends React.Component{
	...
	componentDidMount(){
        var url="https://newsapp-backend.appspot.com/guardian/section?sec=technology";
        ...
        var url1="https://newsapp-backend.appspot.com/newyork/section?sec=technology";
		fetch(url1)
		.then(response => {
			if(response.status !==200){
				throw new Error("File not recieved")
	...
	render(){
		...
		<Navbar.Collapse id="responsive-navbar-nav">
			<Nav className="mr-auto" >
				...
				<Nav.Link as={Link} to="/Technology" href="/Technology" style={{color:"white"}}>Technology</Nav.Link>
