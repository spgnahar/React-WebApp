...
import ReactTooltip from 'react-tooltip'
 ...
 class Sports  extends React.Component{
	...
	componentDidMount(){
        var url="https://newsapp-backend.appspot.com/guardian/section?sec=sport";
        console.log('Sports')
		fetch(url)
		.then(response => {
        ...
        var url1="https://newsapp-backend.appspot.com/newyork/section?sec=sports";
		fetch(url1)
		.then(response => {
			if(response.status !==200){
				throw new Error("File not recieved")
	...
	render(){
		...
		<Navbar.Collapse id="responsive-navbar-nav">
			<Nav className="mr-auto" >
				...
				<Nav.Link as={Link} push to="/Sports" href="/Sports" style={{color:"white"}}>Sports</Nav.Link>
			</Nav>
			<Nav>
